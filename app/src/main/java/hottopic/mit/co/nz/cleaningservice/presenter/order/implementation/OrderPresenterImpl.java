...
import hottopic.mit.co.nz.cleaningservice.model.order.implementation.OrderModel;
...
public class OrderPresenterImpl implements IOrderPresenter {
    ...
    public ServiceTypes sortingTypeData(List<ProductResponse> products){
        ...
        ServiceTypes serviceTypes = new ServiceTypes(mainServiceTypes);
        int sub_position = 0;
        int main_position = 0;
        ...
        for(int i = 0; i < products.size(); i++){
            ServiceProduct serviceProduct = new ServiceProduct(products.get(i).getId(),
                    ...
                    products.get(i).getUnit(), products.get(i).getUnit_price(), products.get(i).getProduct_icon(), 0);
    ...
    public static List<Order> sortingOrders(List<OrderResponse> orderResponses){
