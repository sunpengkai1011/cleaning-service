...
public class CustomDatePicker {
    ...
    public CustomDatePicker(Context context, ResultHandler resultHandler, String startDate, String endDate) {
        if (isValidDate(startDate, "dd/MM/yyyy HH:mm") && isValidDate(endDate, "dd/MM/yyyy HH:mm")) {
            canAccess = true;
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm", Locale.CHINA);
    ...
    public void show(String time) {
        if (canAccess) {
            if (isValidDate(time, "dd/MM/yyyy")) {
    ...
    public void setSelectedTime(String time) {
        if (canAccess) {
            ...
            year_pv.setSelected(dateStr[2]);
            selectedCalender.set(Calendar.YEAR, Integer.parseInt(dateStr[2]));
            ...
            day_pv.setData(day);
            day_pv.setSelected(dateStr[0]);
            selectedCalender.set(Calendar.DAY_OF_MONTH, Integer.parseInt(dateStr[0]));
            executeAnimator(day_pv);
